										...
										while($row = mysqli_fetch_array($re))
										{
											...
											if($id % 2 ==0 )
											{
												echo"<tr class='gradeC'>
                                                    ...
                                                    <td>
                                                    <a href=usersettingdel.php?eid=".$id ." 
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input name="usname" value="<?php echo $us; ?>" class="form-control" placeholder="Enter User name" required>
											</div>
										</div>
										<div class="modal-body">
                                            <div class="form-group">
                                            <label>Change Password</label>
                                            <input name="pasd" value="<?php echo $ps; ?>" class="form-control" placeholder="Enter Password" required>
											</div>
                                        </div>
